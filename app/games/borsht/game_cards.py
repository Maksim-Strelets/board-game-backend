base_cards = [
    ...
    *[{"id": "vinnik_lard", "type": "extra", "name": "Вінницьке сало", "cost": 6, "points": 0} for _ in range(2)],
    ...
    *[{"id": "vitamin_bunch", "type": "extra", "name": "Вітамінний пучок", "cost": 2, "points": 2} for _ in range(2)],
    ...
    # special
    *[{"id": "chili_pepper", "type": "special", "name": "Перець вогник", "cost": 4, "effect": "steal_or_discard"} for _ in range(6)],
    *[{"id": "black_pepper", "type": "special", "name": "Чорний перець", "cost": 3, "effect": "discard_or_take"} for _ in range(4)],
    *[{"id": "sour_cream", "type": "special", "name": "Сметана", "cost": 4, "effect": "defense"} for _ in range(4)],
    *[{"id": "ginger", "type": "special", "name": "Імбир", "cost": 3, "effect": "take_market"} for _ in range(3)],
    *[{"id": "cinnamon", "type": "special", "name": "Кориця", "cost": 5, "effect": "take_discard"} for _ in range(3)],
    *[{"id": "olive_oil", "type": "special", "name": "Оливкова олія", "cost": 3, "effect": "look_top_5"} for _ in range(3)],
    *[{"id": "paprika", "type": "special", "name": "Паприка", "cost": 4, "effect": "refresh_market"} for _ in range(3)],
]
