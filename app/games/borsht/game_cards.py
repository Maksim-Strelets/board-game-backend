...
skvarkas_disposable = [
    {"id": "blackout", "name": "Блекаут", "description": "Кожен гравець може негайно викласти з руки у свій борщ 1 інгредієнт долілиць. Цей інгредієнт не можна скинути або забрати."},
    {"id": "u_komori_myshi", "name": "У коморі завелися миші", "description": "Кожен гравець скидає 2 будь-які інгредієнти з руки гравця ліворуч."},
    {"id": "garmyder_na_kuhni", "name": "Тотальний гармидер на кухні", "description": "Кожен гравець передає свою карту рецепта гравцеві ліворуч і тепер варить новий борщ. Інгредієнти, яких немає в новому рецепті, скидають."},
    {"id": "zazdrisni_susidy", "name": "Заздрісні сусіди", "description": "Гравець з найбільшою кількістю ПО скидає будь-який рідкісний інгредієнт з борщу."},
    {"id": "kuhar_rozbazikav", "name": "Балакучий кухар усе розбазікав", "description": "Усі гравці кладуть свої карти рецептів горілиць і залишають їх так до кінця партії."},
    {"id": "mityng_zahysnykiv", "name": "Мітинг захисників тварин", "description": "Кожен гравець скидає свинину або яловичину зі свого борщу."},
    {"id": "yarmarok", "name": "Ярмарок", "description": "Кожен з гравців обирає карту з руки та передає гравцю ліворуч."},
    {"id": "zlodyi-nevdaha", "name": "Злодюжка-невдаха", "description": "Гравець з найменшою кількістю ПО може забрати у свій борщ інгредієнт з борщу іншого гравця."},
    {"id": "vtratyv_niuh", "name": "Кухар втратив нюх після ковіду", "description": "Кожен гравець скидає будь-який додатковий інгредієнт з борщу гравця праворуч."},
    {"id": "den_vrozhaiu", "name": "День збору врожаю", "description": "Кожен гравець скидає з борщу 1 інгредієнт, який зараз є на ринку."},
    {"id": "zgorila_zasmazhka", "name": "Згоріла засмажка", "description": "Всі гравці скидають цибулю та моркву зі своїх борщів."},
    {"id": "zagubyly_spysok", "name": "Загубили список покупок", "description": "Кожен гравець скидає з борщу 1 інгредієнт, якого зараз немає на ринку."},
    {"id": "rozsypaly_specii", "name": "Розсипали спеції", "description": "Кожен гравець скидає інгредієнт з борщу гравця ліворуч (той може захиститися сметаною)."},
    {"id": "postachalnyk_pereplutav", "name": "Постачальник усе переплутав", "description": "Починаючи з активного гравця, кожен по черзі скидає всі карти з руки та бере 5 нових з колоди."},

]
skvarkas_permanent = [
    {"id": "defolt_crisa", "name": "Дефолт, криза, інфляція", "description": "Відтепер під час обміну на ринку треба платити на 1 більше."},
    {"id": "sanepidemstancia", "name": "Санепідемстанція закрила ринок", "description": "Активний гравець скидає з ринку 2 будь-які інгредієнти. Відтепер ринок має на 2 інгредієнти менше."},
    {"id": "kayenskyi_perec", "name": "Закупили каєнський перець", "description": "Відтепер ефект перцю вогник - забрати / скинути 2 інгредієнти замість 1."},
    {"id": "porvalas_torbynka", "name": "Порвалася торбинка", "description": "Відтепер кожен гравець може мати на руці не більше ніж 4 карти. Гравці повинні негайно скинути зайві карти на свій вибір."},
    {"id": "peresolyly", "name": "Пересолили", "description": "Відтепер не можна додавати в борщ нові додаткові інгредієнти (уже додані інгредієнти залишаються)."},
    {"id": "molochka_skysla", "name": "Молочка скисла", "description": "Відтепер для захисту від будь-якого перцю треба грати 2 сметани."},
]